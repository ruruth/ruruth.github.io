...
I find that, on each page, under <div id="property_list>, includes all property information I want.<br>
![property_list.png]({{site.baseurl}}/images/property_list.png)[property_link](https://github.com/ruruth/ruruth.github.io/blob/master/images/property_list.png)<br>
<br>
<br>
<br>
